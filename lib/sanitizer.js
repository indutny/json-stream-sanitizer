  ...
  _transform(chunk, encoding, callback) {
    ...
    while (offset !== chunk.length) {
      ...
      if (this[kUnicodeLeft] !== 0) {
        const eat = Math.min(chunk.length - offset, this[kUnicodeLeft]);

        this[kString] += chunk.toString('utf8', offset, offset + eat);
        offset += eat;

        this[kUnicodeLeft] -= eat;
        continue;
      }
      ...
      // Escape
      this[kInEscape] = true;
      this[kString] += chunk.toString('utf8', offset, escape + 1);
      offset = escape + 1;
    }
